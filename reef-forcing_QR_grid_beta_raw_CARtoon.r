...
fit_CARtoons <- stan('model_QR_grid_beta_raw_CARtoons.stan',
                data = model_data,
                iter = 1000,
                chains = 4,
                thin = 1,
...
save(fit_CARtoons,file='CARtoonsfit_raw_coral.Rdata')
# 
# # 
...
# 
# 
# ry <- get_posterior_mean(fit_CARtoons,pars='resid_y')[,1]
